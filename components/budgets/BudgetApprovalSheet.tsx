...
export const BudgetApprovalSheet: React.FC<BudgetApprovalSheetProps> = ({
    ...
    if (isMobile) {
        return (
            <Drawer open={open} onOpenChange={onOpenChange}>
                <DrawerContent className="h-[95vh] rounded-t-[10px]">
                    <DrawerHeader className="text-left bg-gradient-to-r from-violet-600 to-indigo-600 text-white rounded-t-[10px] -mx-0">
                        <DrawerTitle className="text-white">Aprovar Orçamento</DrawerTitle>
                        <DrawerDescription className="text-violet-100">
                    ...
                    <div className="p-4 border-t pb-[max(20px,env(safe-area-inset-bottom))]">
                        <ActionsFooter />
                    </div>
                </DrawerContent>
            </Drawer>
    ...
    return (
        <Sheet open={open} onOpenChange={onOpenChange}>
            <SheetContent side="right" className="sm:max-w-md p-0 border-l border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-2xl flex flex-col h-full">
                {/* Header Estilizado */}
                <div className="bg-gradient-to-r from-violet-600 to-indigo-600 p-6 text-white text-center shrink-0">
