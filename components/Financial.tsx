...
const Financial: React.FC = () => {
  const { 
    ...
    openRegister, closeRegister, payExpense 
  } = useData();
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 h-fit">
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <div className="text-xl font-bold text-gray-900 dark:text-white border-b dark:border-gray-700 pb-2">R$ {currentRegister.calculatedBalance.toLocaleString('pt-BR')}</div>
                        </div>
                        <div>
