...
type SettingType = "lead_source" | "custom_lead_status";

const CRMSettings: React.FC = () => {
    const [activeTab, setActiveTab] = useState<SettingType>("lead_source");
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                        Gerencie fontes de leads e status do funil de vendas
                    </p>
                </div>
            </div>
