...
import { Plus, Edit, Trash2, Loader, Save, X, FileText } from "lucide-react";
  ...
  const handleSave = async (procedureData: Partial<Procedure>) => {
    ...
    try {
      ...
      const dataToSave = {
        ...
        duration_min: procedureData.duration_min || 30,
        sessions: procedureData.sessions || 1,
        base_price: procedureData.base_price,
        code_tuss: procedureData.code_tuss || null,
        description: procedureData.description || null,
        is_active: procedureData.is_active ?? true,
      };
...
const Modal: React.FC<ModalProps> = ({
  ...
  const [formData, setFormData] = useState({
    ...
    duration_min: procedure?.duration_min || 30,
    sessions: procedure?.sessions || 1,
    base_price: procedure?.base_price || 0,
    code_tuss: procedure?.code_tuss || "",
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                type="text"
                value={formData.code_tuss}
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...prev,
                    code_tuss: e.target.value,
                  }))
                }
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
