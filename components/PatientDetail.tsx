...
export const PatientDetailSheet: React.FC<PatientDetailProps> = ({
    ...
    if (isMobile) {
        ...
        return (
            <Drawer open={open} onOpenChange={onClose}>
                <DrawerContent className="h-[95vh] overflow-hidden p-0 rounded-t-[10px] outline-none flex flex-col">
                    <DrawerHeader className="sr-only">
                    ...
                    <div className="flex-1 overflow-y-auto bg-background relative">
                        ...
                        <Drawer open={showBudgetForm} onOpenChange={setShowBudgetForm}>
                            <DrawerContent className="h-[95vh] rounded-t-[10px] flex flex-col outline-none">
                                <DrawerHeader className="sr-only">
