-- ============================================
-- FIX: Corrigir sintaxe do pg_net.http_post
-- ============================================
-- A extensão pg_net usa sintaxe diferente
-- Vamos atualizar os triggers com a sintaxe correta
-- ============================================

-- Primeiro, garantir que pg_net está habilitado
CREATE EXTENSION IF NOT EXISTS pg_net;

-- ============================================
-- CORRIGIR SNIPER AGENT
-- ============================================
...
BEGIN
  ...
  -- 3. DISPARO UNIVERSAL (sintaxe correta do pg_net)
  SELECT net.http_post(
    url := v_edge_url || '/agent-orchestrator',
    headers := ('{"Authorization": "Bearer ' || v_service_key || '", "Content-Type": "application/json"}')::jsonb,
...
DO $$
BEGIN
  RAISE NOTICE '✅ Triggers corrigidos com sintaxe pg_net correta!';
  RAISE NOTICE '📋 Agora pode testar com TEST_SQUAD_BOS.sql';
END $$;
